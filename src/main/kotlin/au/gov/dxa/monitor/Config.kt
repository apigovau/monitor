...
data class Config(val sites:List<SiteDTO>, val lambdas:List<LambdaDTO> = listOf(), val widgets:List<WidgetDTO> = listOf(), val styles:List<StyleDTO> = listOf())
...
data class BarChartDTO(val label:String, val style:String, val variable:String, val collection:String = "")
data class StyleDTO(val collection:String, val color:String)